...
import { EmailAdapter } from "./domain/EmailAdapter";
...
let whatsappNotifier = new WhatsAppAdapter();
let emailNotifier = new EmailAdapter();
let customer = new Customer("John Doe", "j.doe@email.com", "06-37294729", emailNotifier);
let customer2 = new Customer("Henk", "henk@gmail.com", "06-29566203", whatsappNotifier);
...
let order1 = new Order(1, false, customer); // niet student order
...
let order2 = new Order(1, false, customer); // niet student order
...
let order3 = new Order(1, true, customer); // student order
...
let order4 = new Order(1, true, customer); // student order
...
let order5 = new Order(1, false, customer); // niet student order
...
let order6 = new Order(1, false, customer); // niet student order
...
let order7 = new Order(1, true, customer); // student order
...
let order8 = new Order(1, false, customer); // niet student order
...
let order9 = new Order(1, false, customer); // niet student order
...
let order12 = new Order(1, false, customer); // CreatedOrderState
...
let order13 = new Order(1, false, customer2); // CreatedOrderState
